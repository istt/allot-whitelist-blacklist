...
export class BlacklistComponent implements OnInit, OnDestroy {
    ...
    private paginateBlacklists(data: IBlacklist[], headers: HttpHeaders) {
    ...
    saveData() {
        this.dataFileService
            .saveData()
            .subscribe(
                (res: HttpResponse<any>) => this.jhiAlertService.success('appApp.blacklist.save'),
