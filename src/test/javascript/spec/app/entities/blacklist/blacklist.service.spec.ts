    ...
    describe('Blacklist Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/blacklists';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Blacklist', () => {
                service.create(new Blacklist(null)).subscribe(received => {
            ...
            it('should update a Blacklist', () => {
                service.update(new Blacklist(123)).subscribe(received => {
