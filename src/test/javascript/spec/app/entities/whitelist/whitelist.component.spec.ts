...
import { WhitelistComponent } from 'app/entities/whitelist/whitelist.component';
...
describe('Component Tests', () => {
    describe('Whitelist Management Component', () => {
        let comp: WhitelistComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(WhitelistComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.whitelists[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
